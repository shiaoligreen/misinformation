...
This annotation task operates at the span and document level: annotators will tag specific linguistic features within headlines (token), as well as classify the overall headline (document-level sentiment).
