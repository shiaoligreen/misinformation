...
| Sprint 4 |  [`app/linguistic_markers_app.py`](app/linguistic_markers_app.py),[`app/styles.css`](app/styles.css), [`app/templates.py`](app/templates.py), [`app/be_fast.py`](app/be_fast.py), [`app/be_search.py`](app/be_search.py), [`app/requirements.txt`](app/requirements.txt), [`app/Dockerfile`](app/Dockerfile), [`app/docker-compose.yml`](app/docker-compose.yml), [`app/testing/test_be_search.py`](app/testing/test_be_search.py), [`app/testing/test_be_fast.py`](app/testing/test_be_fast.py) | [`app/data/cleaned_dataset.csv`](app/data/cleaned_dataset.csv), [`app/data/consolidated_annotations.json`](app/data/consolidated_annotations.json), [`app/data/Gemini_annotations_cleaned.json`](app/data/Gemini_annotations_cleaned.json) | [`weekly_minutes/`](weekly_minutes/sprint4) |
